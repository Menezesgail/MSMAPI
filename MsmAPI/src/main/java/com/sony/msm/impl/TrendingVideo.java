...
import com.sony.msm.model.TrendingVideos;

public class TrendingVideo implements MSMClient {
	...
	public List<Content> getData(int start, int limit) throws Exception,JsonParseException,JsonMappingException{
		...
		HttpGet request = new HttpGet("http://www.sonyliv.com/rest/getTrendingVideos?start="+start+"&limit="+limit);
	...
	//	System.out.println(responseBody);
		...
		List<Content> contentList = getVideoObject.getGetTrendingVideos();
